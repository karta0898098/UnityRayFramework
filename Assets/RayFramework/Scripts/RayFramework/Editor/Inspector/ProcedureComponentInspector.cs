...
namespace UnityRayFramework.Editor
{
    ...
    internal sealed class ProcedureComponentInspectore : RayFrameworkInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.LabelField("Current Procedure", t.CurrentPricedure == null ? "None" : t.CurrentPricedure.GetType().ToString());
            }
